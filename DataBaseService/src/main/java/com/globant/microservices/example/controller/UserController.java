...
public class UserController {
	...
	public ResponseEntity<UserResource> updateUser(@PathVariable(value = "id", required = true) String id,
	...
	public ResponseEntity<UserResource> findUser(@PathVariable(value = "id", required = true) String id) throws NotFoundException {
	...
	public ResponseEntity<List<UserResource>> search(@RequestParam(value = "request") String request) {

		logger.info("searching information by {}", request);
		List<UserResource> users = userService.findByQuery(request);
		return new ResponseEntity<List<UserResource>>(users, HttpStatus.OK);
	}
